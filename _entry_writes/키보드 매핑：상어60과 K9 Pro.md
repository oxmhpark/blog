...
tags:
  ...
  - QMK (키보드 펌웨어)
  - VIA (키보드 매핑 앱)
excerpt: 현역인 K9 Pro와 백업용 상어60을 리매핑했다. 기존의 Home·End·PgDn·PgUp 입력 지원에 더해서, 3개의 Fn 키들(SpaceFn·CapsFn·TabFn)을 이용해서 CapsLock·NumLock·ScrlLock·Print·F13~F24·M0~M15 입력 지원을 추가했다.
---
